...
const Navbar = () => {
    ...
    return (
        <div className=' p-4 main-navbar flex justify-center items-center space-x-8 mdm:space-x-0 mdm:fixed mdm:bg-[#1e1d1d] mdm:w-[100vw] mdm:p-2  mdm:top-0 mdm:left-0 mdm:justify-start mdm:items-start z-10'>
            <ul ref={ref} className={'flex space-x-10 justify-center items-center cursor-pointer text-white mdm:flex-col mdm:justify-start mdm:items-start mdm:space-y-6 mdm:space-x-0 mdm:fixed mdm:top-10 mdm:right-[-400px] mdm:w-[200px] mdm:h-[100vh] mdm:bg-[#1e1d1d] mdm:shadow-2xl mdm:pt-[40px] mdm:pl-3 mdm:z-10 duration-500 ease-in-out'}>
                ...
                <AnchorLink href  = '#project'><li onClick={handleClick} className='hover:border-b-2 hover:border-b-yellow-300 transition duration-300 ease-in-out h-6 hover:scale-110 hover:text-yellow-300 active:text-yellow-300'>PROJECTS</li></ AnchorLink>
